...
Complete this checklist immediately before submitting through Turnitin/Moodle. Do not treat a checked box as a substitute for opening the link and confirming the claimed evidence in a clean browser session.
...
- [ ] The document is within the required 1,500–2,500 word range, excluding diagrams, screenshots, and code excerpts.
- [ ] “Your Organisation” explains the Google Learning Architects business challenge and the reason for an agentic approach.
- [ ] “Agent Designs” includes the five names, roles, full system prompts, outputs, personalities, and expertise.
- [ ] “Pipeline in Action” explains the actual cumulative run and includes stage-by-stage screenshots or transcript excerpts.
- [ ] The public GitHub Pages URL is prominent, correct, and login-free.
- [ ] Regulatory and ethical material addresses the actual design, GDPR, customer trust, and current EU AI Act references.
- [ ] Every factual regulatory/source claim has been checked and cited using authoritative references.
- [ ] The AI-use disclosure identifies the model, prompt/system-prompt locations, and human verification performed.
- [ ] The Reflection is personally written by the student, based on genuine run/iteration evidence, and was not generated with AI.
